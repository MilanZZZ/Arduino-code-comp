...
Pins:
 * GND = GND
 * VCC = 5Vggggggggggggggggggggggggggg   u
 * SDA = A4,,,,,,,
...
//  display.setCursor(30, 10);  // (x,y)
 //display.println("TEST");  // Text or value to print
 if (buttonState == HIGH) {
 
 display.setCursor(20, 30);  // (x,y)
 display.println("Warframe");
 Serial.println("1");
 delay(10);
  } 
  else {
...
///////////////////
 ...
 // display.fillTriangle(0,63,   15,45,   30,63, WHITE);  // Draw filled triangle. X, Y coordinates for three corner points defining the triangle, followed by a color
  ...
  // Draw line:
 // display.drawLine(20,0, 20, 60, WHITE);  // Draw line (x0,y0,x1,y1,color)
