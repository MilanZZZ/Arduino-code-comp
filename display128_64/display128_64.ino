...
void loop()  // Start of loop
{
 ...
 // display.fillTriangle(0,63,   15,45,   30,63, WHITE);  // Draw filled triangle. X, Y coordinates for three corner points defining the triangle, followed by a color
  ...
  delay(1000);
  display.display();
  display.drawLine(20,0, 60, 60, WHITE);
  delay(1000);
  display.display();
  display.drawLine(100,0, 60, 60, WHITE);
  delay(1000);
  display.display();
  display.drawLine(100,0, 100, 60, WHITE);
  delay(1000);
  display.display();
  // Draw circle:
  delay(1000);
  display.drawCircle(64, 32, 30, WHITE);  //  Draw circle (x,y,radius,color). X and Y are the coordinates for the center point
  delay(1000);
  display.display();
